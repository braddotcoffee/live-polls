...
def full_match_detection(
    message: str, positive_keyword: str, negative_keyword: str
) -> VoteDetectionResult:
...
class VoteDetectionService:
    ...
    def __init__(
        self, vote_mode: VoteDetectionMode, positive_keyword: str, negative_keyword: str
    ):
    ...
    def is_vote(self, message: str) -> VoteDetectionResult:
        return self.detection_handler(
            message, self.positive_keyword, self.negative_keyword
        )
